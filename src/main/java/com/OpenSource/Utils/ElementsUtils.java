...
public class ElementsUtils {
	...
	public ElementsUtils(WebDriver driver) {
		this.driver = driver;
		jsUtil = new JsUtils(this.driver);
	}
	...
	/**
	 * getELement--Method we have added Highlist option if we would like to show
	 * teammates or client the flash part of highliting element
	 * 
	 * @param locator
	 * @return
	 */
